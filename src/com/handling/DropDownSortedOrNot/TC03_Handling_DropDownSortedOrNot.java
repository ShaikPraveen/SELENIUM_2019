...
public class TC03_Handling_DropDownSortedOrNot
{
	public static void main(String[] args) {
		...
		Select sele=new Select(driver.findElement(By.xpath("//select[@name='animals']")));
		...
		{
		   System.out.println("DROP DOWN VALUES SORTED");	
		} else 
		{
